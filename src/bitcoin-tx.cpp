...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lilith-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lilith-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lilith transaction") + "\n" +
              "  lilith-tx [options] -create [commands]   " + _("Create hex-encoded lilith transaction") + "\n" +
              "\n";

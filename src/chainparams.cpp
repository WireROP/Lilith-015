...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.lilith.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.lilithtools.com", true);
        vSeeds.emplace_back("dnsseed.lilithpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.lilithtools.com", true);
        vSeeds.emplace_back("seed-b.lilith.loshan.co.uk", true);

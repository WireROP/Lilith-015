...
const char * const BITCOIN_CONF_FILENAME = "lilith.conf";
const char * const BITCOIN_PID_FILENAME = "lilith.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lilith";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Lilith";
#else
    // Unix
    return pathRet / ".lilith";
#endif
#endif
}

...
#if defined(NDEBUG)
# error "Lilith cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Lilith Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LIL additional fees, %d delta bytes\n",
